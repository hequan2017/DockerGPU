...
export const deleteComputeNodeByIds = (params) => {
  return service({
    url: '/cmpNode/deleteComputeNodeByIds',
    method: 'delete',
    params
  })
}
...
export const getComputeNodeList = (params) => {
  return service({
    url: '/cmpNode/getComputeNodeList',
    method: 'get',
    params
  })
}
...
export const getComputeNodePublic = () => {
  return service({
    url: '/cmpNode/getComputeNodePublic',
    method: 'get',
  })
}
