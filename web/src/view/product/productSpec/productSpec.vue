...
<template>
  ...
  <el-input v-model.number="searchInfo.systemDiskGB" placeholder="搜索条件" />
</el-form-item>
            
            <el-form-item label="数据盘容量(GB)" prop="dataDiskGB">
  <el-input v-model.number="searchInfo.dataDiskGB" placeholder="搜索条件" />
</el-form-item>
            
            <el-form-item label="价格/小时" prop="pricePerHour">
  <el-input v-model.number="searchInfo.pricePerHour" placeholder="搜索条件" />
</el-form-item>
  ...
  <el-input v-model="searchInfo.remark" placeholder="搜索条件" />
    ...
    <el-input v-model.number="formData.memoryGB" :clearable="false" placeholder="请输入内存(GB)" />
            ...
            <el-form-item label="系统盘容量(GB):" prop="systemDiskGB">
    <el-input v-model.number="formData.systemDiskGB" :clearable="false" placeholder="请输入系统盘容量(GB)" />
</el-form-item>
            <el-form-item label="数据盘容量(GB):" prop="dataDiskGB">
    <el-input v-model.number="formData.dataDiskGB" :clearable="false" placeholder="请输入数据盘容量(GB)" />
</el-form-item>
            <el-form-item label="价格/小时:" prop="pricePerHour">
